...
## Main Advantage
No binning and hence **no curse of dimensionality**. Therefore, **it works on modern deep neural networks** (e.g., ResNet50 layers), not just on toy models with double digit layer width. See the "Limitations of the Classic Shannon Entropy and Mutual Information" section in our paper for details.
