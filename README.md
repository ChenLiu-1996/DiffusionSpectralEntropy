...
## Main Advantage
No binning and hence **no curse of dimensionality**. Therefore **it can work on modern deep neural networks** (e.g., ResNet50 layers) instead of only on toy models (layer width at most 10 or 20). See the "Limitations of the Classic Shannon Entropy and Mutual Information" section in our paper for details.
